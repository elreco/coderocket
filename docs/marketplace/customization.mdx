...
description: "Learn how to modify and customize your purchased marketplace components"
icon: "code"
---
...
<CardGroup cols={3}>
  ...
  <Card title="Component Documentation" icon="book">
...
Ready to start customizing? Download your purchased components from [My Purchases](https://coderocket.app/account/marketplace/purchases) and begin making them your own!