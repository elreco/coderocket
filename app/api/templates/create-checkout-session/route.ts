...
export async function POST(req: Request) {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      mode: "payment",
      success_url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.coderocket.app"}/account/templates/purchases?purchase=success&listing=${listingId}`,
      cancel_url: `${process.env.NEXT_PUBLIC_SITE_URL || "https://www.coderocket.app"}/templates/${listingId}`,
      metadata: {
