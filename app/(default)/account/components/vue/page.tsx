...
export const metadata = {
  title: `My Vue components - Tailwind AI`,
  description:
    "My last Tailwind Vue components generated with AI by our users with Vue and Tailwind CSS",
};

export default async function MyReactComponents() {
  const chats = await getVueChatsFromUser();
  return (
    <Container className="pr-2 sm:pr-11">
      <PageTitle
        title="My Vue Components"
        subtitle="My generated Vue components"
      />
      <div className="mb-8 flex gap-4">
        ...
        <Button asChild variant="secondary">
          <Link href="/components/vue" className="flex items-center gap-2">
            <Globe className="size-4" />
            <span>Browse Public Vue Components</span>
          </Link>
        </Button>
      </div>
