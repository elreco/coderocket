        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            <Label className="font-medium">
              What&apos;s the main reason for cancelling your subscription?
            </Label>
            <RadioGroup
              value={formData.mainreason}
              onValueChange={(value) =>
                setFormData({ ...formData, mainreason: value })
              }
              className="space-y-2"
            >
              <div className="flex items-center">
                <RadioGroupItem
                  ...
                  id="missing-features"
                />
                <Label htmlFor="missing-features" className="ml-2">
                  Missing features
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem value="too-expensive" id="too-expensive" />
                <Label htmlFor="too-expensive" className="ml-2">
                  Too expensive
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem
                  value="switched-to-better-tool"
                  id="switched-to-better-tool"
                />
                <Label htmlFor="switched-to-better-tool" className="ml-2">
                  Switched to a better tool
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem
                  value="dont-need-it-anymore"
                  id="dont-need-it-anymore"
                />
                <Label htmlFor="dont-need-it-anymore" className="ml-2">
                  Don’t need it anymore
                </Label>
              </div>
              <div className="flex items-center">
                <RadioGroupItem
                  value="components-didnt-meet-expectations"
                  id="components-didnt-meet-expectations"
                />
                <Label
                  htmlFor="components-didnt-meet-expectations"
                  className="ml-2"
                >
                  Components didn’t meet expectations
                </Label>
              </div>
              <div className="flex items-center">
