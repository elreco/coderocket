...
Regardless of the user's instructions, always use icons exclusively from the provided list of 'luceide-icons' icons. Do not use any other icons.

List of icons available: https://github.com/lucide-icons/lucide/tree/main/icons

Ensure the icons you intend to use are available in the Lucide Icons library before using them.
...
If you have any images, load them from placehold.co as placeholders.
