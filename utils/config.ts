...
export const STARTER_PLAN_MESSAGES_PER_PERIOD = 150;
export const PRO_PLAN_MESSAGES_PER_PERIOD = 450;
export const SUPPORTER_PLAN_MESSAGES_PER_PERIOD = 1200;
export const DEFAULT_MESSAGES_PER_PERIOD = 250;
