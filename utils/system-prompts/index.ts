...
<core_configuration>
  ...
  <coderocket_artifact_info>
    ...
    - CRITICAL: NEVER ADD PLACEHOLDER LIKE THIS : \`// Rest of the code remains the same as in the previous generation\`.
      ...
      - For existing files, ALWAYS send the COMPLETE file content with your modifications applied.
  ...
  <interactive_elements>
    ...
    - Example: <Button className="cursor-pointer">Click me</Button>
    - Example: <a className="cursor-pointer" href="#">Link</a>
    - Example: <div onClick={handleClick} className="cursor-pointer">Clickable card</div>
